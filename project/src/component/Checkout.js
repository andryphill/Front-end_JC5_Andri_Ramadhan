                ...
                <div className="container wrapper">
                    ...
                    <form className="form-horizontal" method="post" action>
                        ...
                        <div className="panel panel-info">
                            ...
                            Review Order <div className="pull-right"><small><Link className="afix-1" to="#">Edit Cart</Link></small></div>
                            </div>
                        ...
                        <div className="panel panel-info">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-12">
                                <ul>
                                    <li><Link to="#"><img src="image/visa.png" style={{float: 'left', height: 32, marginRight: 8, width: 51}} /></Link></li>
                                    <li><Link to="#"><img src="image/mastercard.png" style={{float: 'left', height: 32, marginRight: 8, width: 51}} /></Link></li>
                                </ul>
